#Salut ! Pour que la carte s'actualise toutes les deux secondes par exemple, il faut que vous appeliez la fonction positionTwoPoints toutes les 2s. Cela vous créé un fichier .txt avec [[latSatellite, longSatellite],[latPoint1,longPoint1],[latPoint2, longPoint2]] 
