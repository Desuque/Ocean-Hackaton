...
(function() {
  ...
  var texture, nightTexture, patchTexture;
  ...
  earth.init = function() {
    ...
    earthShader.uPatchSampler =           gl.getUniformLocation(earthShader, 'uPatchSampler');
  ...
  patchTexture = gl.createTexture();
    ...
    patchImg.onload = function() {
      ...
      gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, patchImg);
      gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
      gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
      gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.REPEAT	);
      console.log('earth.js loaded patch');
      texLoaded = true;
      onImageLoaded();
    };
  ...
  earth.draw = function(pMatrix, camMatrix) {
    ...
    gl.uniform1i(earthShader.uPatchSampler, 2);  //point sampler to TEXTURE2
    gl.activeTexture(gl.TEXTURE2);
    gl.bindTexture(gl.TEXTURE_2D, patchTexture); //bind tex to TEXTURE2
